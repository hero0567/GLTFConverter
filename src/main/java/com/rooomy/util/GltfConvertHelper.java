...
//        Files.delete(Paths.get(backup));
    ...
    private static void convertGltf(String gltf) throws IOException {
        ...
        JSONObject dataJson = (JSONObject) JSONObject.parse(json, Feature.OrderedField);// ����һ������ԭʼjson����json����
        JSONArray nodes = dataJson.getJSONArray("nodes");// �ҵ�features��json����
        JSONArray meshes = dataJson.getJSONArray("meshes");// �ҵ�features��json����
        ...
        JSONArray translation = jsonObject.getJSONArray("translation");// �ҵ�features��json����
        JSONArray scale = jsonObject.getJSONArray("scale");// �ҵ�features��json����
